...
const seed = async() => {
  const [rgfa, evolve, mga] = await Promise.all([
    School.create({
      ...
      description: 'Located in Brookly, we offer BJJ lessons to students from all backgrounds. Drop in for a trial class!',
    }),
    School.create({
      name: 'Evolve MMA',
    ...
    School.create({
      ...
      description: 'NYC’s Premier Martial Arts School and home of 5x World & 4x ADCC Champion Marcelo Garcia.',
    }),
  ]);
